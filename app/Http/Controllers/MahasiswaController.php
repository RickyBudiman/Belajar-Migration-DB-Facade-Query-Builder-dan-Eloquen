...
class MahasiswaController extends Controller
{
    public function insert()
    {
        ...
        alamat, created_at) values (?, ?, ?, ?, ?, ?)',['1822240011','Ricky Budiman','Palembang',
        '2001-01-20','bukit besar', now()]);
        dump($result);
    }
    //
    ...
    public function update()
    {
        ...
        updated_at = now() where npm = ?', ['1822240011']);
        dump($result);
    }

    public function delete()
    {
        $result = DB::delete('delete from mahasiswas where npm = ?', ['1822240011']);
        dump($result);
    }
    ...
    public function insertElq()
    {
        ...
        $mahasiswa->npm ='1822240052';
        $mahasiswa->nama_mahasiswa ='Zainal';
    ...
    {
        $mahasiswa = Mahasiswa::where('npm','1822240052')->first(); //cari data tabel mahasiswas berdasarkan npm
